...
class Tx extends Struct {
   ...
   */
  sighash (nHashType, nIn, subScript, valueBn, flags = Tx.SCRIPT_ENABLE_SIGHASH_FORKID, hashCache = new HashCache()) {
  ...
  sighashPreimage (nHashType, nIn, subScript, valueBn, flags = Tx.SCRIPT_ENABLE_SIGHASH_FORKID, hashCache = new HashCache()) {
