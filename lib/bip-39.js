...
import { en, es, jp } from './bip-39-words'
import { Workers } from './workers'

class Bip39 extends Struct {
  constructor (mnemonic, seed, wordlist) {
  ...
  setLang (lang) {
    switch (lang) {
      case 'es': this.Wordlist = es; break
      case 'jp': this.Wordlist = jp; break
      case 'en': default: this.Wordlist = en; break
    }
  }
