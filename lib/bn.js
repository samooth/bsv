...
Bn.prototype.fromScriptNumBuffer = function (
  ...
  if (buf.length > nMaxNumSize) {
    throw new Error(`script number overflow nMaxNumSize: ${nMaxNumSize}`)
  }
  ...
  // TODO?
  // https://github.com/bitcoin-sv/bitcoin-sv/blob/4d3444909a5a98f129d3d2991bf8f0f7f15d3969/src/script/script_num.cpp#L34
  if (buf.byteLength === 0) {
    if (bigInt) {
      // m_value = bint{0};
    }
  } else if (buf.byteLength <= nMaxNumSize) {
    if (bigInt) {
